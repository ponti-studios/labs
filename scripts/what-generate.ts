...
import { CIRCUIT_BREAKER_THRESHOLD, createCircuitBreaker } from "../app/lib/what/circuit-breaker";
import { getDateKey } from "../app/lib/what/core/date";
import { resolveGenerateRange } from "../app/lib/what/generate-range";
import { WHAT_READY_INVENTORY_DAYS, runGenerateRange } from "../app/lib/what/generation-runner";
import { getActiveGames } from "../app/lib/what/server/games.server";
import {
  backfillPuzzlePublishedAt,
  countInventoryForRange,
} from "../app/lib/what/server/puzzles.server";
...
async function main() {
  ...
  const { expireGenerations, reapStaleGenerations } =
    await import("../app/lib/what/admin/generate.server");
