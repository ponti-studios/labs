...
import {
  ...
  generateCandidates,
} from "../app/lib/what/generation/generate.server";
import { PROMPT_TEST_FIXTURES } from "../app/lib/what/fixtures/prompt-test-fixtures";
import { readSourceFixture, type SourceFixture } from "../app/lib/what/fixtures/source-fixtures";
...
const CLI_ACTOR = "cli:what-prompt-test";
...
async function main() {
  ...
  const promptFiles =
    options.promptFiles.length > 0
      ? options.promptFiles
      : ["app/lib/prompts/what-generation.md", "app/lib/prompts/what-generation-v2.md"];
