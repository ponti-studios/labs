/**
 * Pure aggregation over a user's RealiTea attempts — no DB access, so this
 ...
 */
import type { RealiteaAttempt } from "~/lib/server/db";
...
type StatsAttempt = Pick<RealiteaAttempt, "dateUtc" | "status" | "guesses">;
