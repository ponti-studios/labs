...
import { explainGenerateReason, GenerateReasonType, generateStagePercent } from "../admin/generate-copy";
...
describe("generate copy", () => {
  it("turns machine reasons into operator language", () => {
    ...
    expect(explainGenerateReason("answer is leaked in clue or detail")).toContain("gives the word away");
