...
type GlobalBus = typeof globalThis & {
  __whatGenerationBus?: Map<number, Set<Listener>>;
};

const globalBus = globalThis as GlobalBus;
const listeners = globalBus.__whatGenerationBus ?? new Map<number, Set<Listener>>();
globalBus.__whatGenerationBus = listeners;
