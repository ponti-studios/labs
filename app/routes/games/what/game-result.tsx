...
export function WhatGameResult({ game, puzzle, loginUrl, onShare, onCopy }: WhatGameResultProps) {
  if (game.authRequired) {
    return (
      <Card className="border-(--what-present-border)" data-testid="what-auth-required">
  ...
  return (
    <div className="flex flex-col gap-3" data-testid="what-result">
      ...
      <div>
        <div className={`${styles.receipt} flex gap-4`} data-testid="what-receipt">
