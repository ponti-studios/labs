  ...
  const services = [
    {
      ...
      copy:
        'From concept to roadmap: product framing, opportunity sizing, user workflows, and technical direction for AI-native software.',
    },
    {
      title: 'Agent Systems',
      copy:
        'Harness architecture, tools, skills, command systems, eval loops, and production patterns for reliable agentic products.',
    },
    {
      title: 'Design + Engineering',
      copy:
        'High-taste interfaces and full-stack execution across web, mobile, APIs, infra, and developer tooling.',
    },
  ];
        ...
        <div className="mx-auto max-w-7xl px-6 py-6 md:px-10">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div className="text-lg font-black tracking-tight md:text-xl">STNDRDS.</div>
            </div>
          ...
          <div className="grid gap-14 lg:grid-cols-[1.35fr_.65fr] lg:items-end">
            <div>
              ...
              <p className="mt-6 max-w-2xl text-base leading-7 text-black/70 md:text-lg">
                STNDRDS. is an AI product studio for founders, teams, and companies building serious software.
            ...
            <div className="rounded-[2rem] border border-black/10 bg-black p-7 text-white shadow-2xl shadow-black/10">
              ...
              <div className="mt-8 rounded-2xl border border-white/10 bg-white/5 p-5">
                ...
                <div className="mt-2 text-2xl font-bold leading-tight">Small team. High standard. End-to-end execution.</div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="mx-auto max-w-7xl px-6 py-20 md:px-10">
          <div className="mb-12 flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
            <div>
              ...
              <h2 className="mt-3 text-3xl font-black tracking-[-0.04em] md:text-5xl">Built for teams shipping real AI.</h2>
            </div>
          ...
          <div className="grid gap-5 md:grid-cols-3">
            {services.map((service) => (
              <div key={service.title} className="rounded-[1.75rem] border border-black/10 bg-white p-7 shadow-sm">
                <div className="text-sm font-semibold uppercase tracking-[0.18em] text-black/45">{service.title}</div>
      ...
      <section id="work">
        <div className="mx-auto max-w-7xl px-6 py-20 md:px-10">
          <div className="mb-12 grid gap-8 lg:grid-cols-[.8fr_1.2fr]">
            <div>
              <div className="text-xs font-semibold uppercase tracking-[0.22em] text-black/45">Selected focus</div>
              <h2 className="mt-3 text-3xl font-black tracking-[-0.04em] md:text-5xl">Systems first. Brand second. Never separate.</h2>
            </div>
            <p className="max-w-2xl text-base leading-7 text-black/68">
              The best AI products do not just work—they feel coherent. We design the logic, the interface,
              the workflows, and the language as one operating system.
            </p>
          </div>

          <div className="grid gap-5 lg:grid-cols-3">
            {work.map((item) => (
              <div key={item.name} className="group rounded-[1.75rem] border border-black/10 p-7 transition-all hover:-translate-y-1 hover:shadow-xl hover:shadow-black/5">
                <div className="flex items-center justify-between">
                  <div className="text-xs font-semibold uppercase tracking-[0.22em] text-black/40">{item.type}</div>
      ...
      <section className="border-y border-black/10 bg-black text-white">
        <div className="mx-auto grid max-w-7xl gap-8 px-6 py-16 md:px-10 lg:grid-cols-2 lg:items-center">
          <div>
            ...
            <h2 className="mt-3 text-3xl font-black tracking-[-0.04em] md:text-5xl">A studio shaped by standards.</h2>
          </div>
          <div className="grid gap-4 sm:grid-cols-2">
            {principles.map((item) => (
              <div key={item} className="rounded-2xl border border-white/10 bg-white/5 px-5 py-6 text-lg font-semibold">
                {item}
              </div>
            ))}
          </div>
        ...
        <div className="mx-auto max-w-7xl px-6 py-20 md:px-10">
          <div className="grid gap-10 lg:grid-cols-[1fr_.8fr]">
            <div>
              ...
              <h2 className="mt-3 text-3xl font-black tracking-[-0.04em] md:text-5xl">We help ambitious teams turn AI potential into product reality.</h2>
            </div>
            <div className="space-y-5 text-base leading-8 text-black/70">
              <p>
                STNDRDS. partners with companies that need more than prototypes. We help define the product,
