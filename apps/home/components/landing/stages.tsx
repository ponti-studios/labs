...
const businessStages: BusinessStage[] = [
  {
    ...
    benefits: ["MVP in 6-8 weeks", "User validation", "Investor-ready presentations"],
  },
  {
    type: "Growing",
    ...
    benefits: ["Scalable architecture", "Enhanced user experiences", "Revenue optimization"],
  },
  {
    type: "Established",
    ...
    benefits: ["Enterprise security", "System integration", "Market innovation"],
  },
];
...
export function Stages() {
  ...
  return (
    <motion.section className="relative w-full py-16 lg:py-24" ref={sectionRef} {...fadeInUp}>
      <div className="space-y-8">
        <div className="space-y-4">
          ...
          <p className="text-text-secondary text-lg md:text-xl font-light">
            We've partnered with companies at every growth phase. Here's how we can help at your
            stage.
          </p>
        </div>
                ...
                <div className="flex flex-col z-10 gap-4">
                  <div className="flex items-start">
                    <div>
                      ...
                      <p className="text-sm text-text-secondary font-light">{stage.subtitle}</p>
                    </div>
                  </div>
                  ...
                  <div className="space-y-2">
                    {stage.benefits.map((benefit, benefitIndex) => (
                      ...
                      >
                        ...
                        />
                        <span className="text-text-secondary font-light">{benefit}</span>
                      </motion.div>
                    ))}
                  </div>
                </div>
