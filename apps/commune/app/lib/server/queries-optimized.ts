...
export async function getTracker(id: string): Promise<SocialTrackerParsed | null> {
...
export async function getTrackersWithStats(): Promise<
  (SocialTrackerParsed & { voteStats: { total: number; stay: number; stayPercentage: number } })[]
> {
