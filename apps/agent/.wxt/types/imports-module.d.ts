...
declare module '#imports' {
  ...
  export { default as ChatInput } from '../src/components/ChatInput';
  export { default as ChatMessage } from '../src/components/ChatMessage';
  export { default as ContextBar } from '../src/components/ContextBar';
}
