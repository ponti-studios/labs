...
import { calculatePenDuration } from "./medication-calculator";

describe("calculatePenDuration", () => {
  it("should calculate partial weeks when medication runs out mid-week", () => {
  ...
  it("should calculate exact usage correctly", () => {
    expect(calculatePenDuration([50, 50], 100)).toBe(2);
    expect(calculatePenDuration([10, 20, 30, 15], 100)).toBe(4);
  });

  it("should stop counting once the pen runs out, ignoring later dosages", () => {
