          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-gray-400 text-lg md:text-xl mb-8 max-w-xl">
                Transform chaotic information into strategic insights that drive business growth and
              ...
              <div className="mt-12 flex items-center">
                ...
                <div className="ml-4">
                  <p className="text-sm text-gray-400">
                    Trusted by <span className="font-medium text-white">200+</span> innovative
                    companies
                  </p>
                </div>
              </div>
      ...
      <div className="py-12 border-t border-b border-gray-800">
        <div className="container mx-auto px-6">
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-8 items-center opacity-50">
            {["ACME", "TechCorp", "Innovate", "FutureLabs", "DataFlow", "Quantum"].map(
              (client, i) => (
        ...
        <div className="container mx-auto px-6">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <p className="text-gray-400">
              Our data solutions unlock hidden patterns and actionable insights, helping you make
      ...
      <div className="py-20 bg-gray-900/50">
        <div className="container mx-auto px-6">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <p className="text-gray-400">
              We follow a systematic approach to unlock the full potential of your data.
            </p>
          </div>
        ...
        <div className="container mx-auto px-6">
          <div className="grid md:grid-cols-4 gap-8">
            <div>
              ...
              <p className="text-gray-400 mb-6">Transforming data chaos into strategic clarity.</p>
