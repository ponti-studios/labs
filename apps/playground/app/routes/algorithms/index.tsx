      ...
      <div className="w-full max-w-6xl mx-auto px-4 py-8 md:py-12 space-y-12">
          ...
          <GridSection cols={3}>
            {algorithms.map((algo) => (
              <Link key={algo.path} to={algo.path}>
                <FeatureCard title={algo.name} description={algo.description} icon={algo.icon} />
              </Link>
            ))}
          </GridSection>
        </PageSection>
        ...
        <PageSection title="About Algorithms">
          <InfoBox>
            ...
            Understanding fundamental algorithms is essential for competitive programming and
