...
export default function GitHubCardRoute() {
  ...
  const typeColors: Record<string, { bg: string; border: string; text: string }> = {
    ...
    following: { bg: "from-blue-500 to-cyan-500", border: "border-blue-500", text: "text-blue-500" },
    repos: { bg: "from-green-500 to-emerald-500", border: "border-green-500", text: "text-green-500" },
  };
...
function StatBadge({
  ...
  return (
    <div
      className={`bg-gradient-to-r ${colors.bg} rounded-xl px-4 py-2 shadow-lg`}
    >
