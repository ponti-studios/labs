	...
	return (
		<div className="min-h-screen bg-gradient-to-b from-slate-50 to-slate-100 dark:from-slate-900 dark:to-slate-800">
			...
			<motion.div
				...
				className="bg-gradient-to-r from-purple-600 via-indigo-600 to-blue-600 text-white py-8 px-4 shadow-lg"
			>
			...
			>
				...
				>
					...
					{allRevealed && (
						<Button onClick={() => setRevealedCards(new Array(cards.length).fill(false))} size="lg" variant="outline">
							🔄 Reset Cards
						</Button>
					)}
				</motion.div>
			...
			>
				<Card className="bg-gradient-to-r from-amber-50 to-orange-50 dark:from-amber-900/20 dark:to-orange-900/20 p-6">
					<h3 className="text-lg font-semibold text-amber-900 dark:text-amber-100 mb-3">💡 How to Use</h3>
