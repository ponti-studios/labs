				...
				<div className="lg:col-span-5 space-y-2 h-[calc(100vh-140px)] overflow-y-auto pr-2 custom-scrollbar pb-20">
					...
					>
						<InputGroup
							...
							onChange={(v: string) =>
								updateField("image_specifications.format", v)
							}
						/>
						<InputGroup
							label="Dimensions"
							...
							onChange={(v: string) =>
								updateField("image_specifications.dimensions", v)
							}
						/>
						<InputGroup
							...
							onChange={(v: string) =>
								updateArrayField("image_specifications.aesthetic", v)
							}
							type="textarea"
						/>
					</Section>
					...
					<Section title="Environment" icon={MapPin}>
						...
						<InputGroup
							...
							onChange={(v: string) =>
								updateField("environment.primary_prop", v)
							}
						/>
						<div className="pt-2 border-t border-slate-700 mt-2">
							...
							<InputGroup
								...
								onChange={(v: string) =>
									updateField("environment.background.visibility", v)
								}
							/>
							...
							<InputGroup
								...
								onChange={(v: string) =>
									updateField("environment.background.ambient_elements", v)
								}
								type="textarea"
							/>
						</div>
					...
					<Section title="Visual Style" icon={Palette}>
						<InputGroup
							...
							onChange={(v: string) =>
								updateField("visual_style.color_palette", v)
							}
						/>
						<InputGroup
							label="Texture"
						...
						<InputGroup
							...
							onChange={(v: string) =>
								updateField("visual_style.lens_characteristics", v)
							}
						/>
					</Section>
				</div>
						...
						{generatedImage ? (
							...
							<div className="text-center p-8">
								...
								<p className="text-slate-500 max-w-sm mx-auto mt-2">
									Configure your parameters on the left and hit generate to
									create a high-fidelity image.
								</p>
							</div>
						)}
