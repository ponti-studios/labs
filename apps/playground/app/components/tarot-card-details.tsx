				...
				{card && (
					<>
						...
						<div className="grid md:grid-cols-2 gap-6">
							<div>
								<h3 className="font-semibold text-green-700 dark:text-green-400 mb-2">✨ Light Meanings</h3>
								<ul className="space-y-1">
									{card.meanings.light.map((meaning) => (
										<li key={meaning} className="text-sm text-gray-600 dark:text-gray-400 flex gap-2">
							...
							<div>
								<h3 className="font-semibold text-red-700 dark:text-red-400 mb-2">🌑 Shadow Meanings</h3>
								<ul className="space-y-1">
						...
						{card.fortune_telling && card.fortune_telling.length > 0 && (
							<div>
								<h3 className="font-semibold text-gray-700 dark:text-gray-300 mb-2">🔮 Fortune Telling</h3>
								<ul className="space-y-1">
						...
						{card["Questions to Ask"] && card["Questions to Ask"].length > 0 && (
							<div>
								<h3 className="font-semibold text-gray-700 dark:text-gray-300 mb-2">❓ Questions to Ask</h3>
								<ul className="space-y-2">
									{card["Questions to Ask"].map((question) => (
										<li key={question} className="text-sm text-gray-600 dark:text-gray-400 italic">
											"{question}"
										</li>
									))}
								</ul>
						...
						{card["Mythical/Spiritual"] && (
							<div className="bg-purple-50 dark:bg-purple-900/30 p-4 rounded-lg border border-purple-200 dark:border-purple-800">
								...
								<p className="text-sm text-gray-600 dark:text-gray-400">{card["Mythical/Spiritual"]}</p>
							</div>
						)}
					</div>
					</>
