    ...
    <div className="space-y-3">
      ...
      <div className="flex items-center justify-between gap-3">
        ...
        <div className="flex items-center gap-1.5">
          ...
          />
          <span
            className={`font-mono text-[10px] uppercase tracking-wider ${isLive ? "text-green-500" : "text-secondary"}`}
          >
            {isLive ? "Live" : "Offline"}
          </span>
        </div>
      ...
      <div>
        <h2 className="text-primary font-semibold leading-tight">{camera.commonName}</h2>
        <p className="text-secondary mt-0.5 font-mono text-[10px] uppercase tracking-widest">
          {camera.id}
        </p>
        <div className="text-secondary mt-2 space-y-1 font-mono text-[10px] uppercase tracking-widest">
