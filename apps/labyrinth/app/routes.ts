...
const challengeRoutes = [
  ...
  route("/challenges/goldman-sachs/fee-or-upfront", "routes/challenges.goldman-sachs.fee-or-upfront.tsx"),
  route("/challenges/goldman-sachs/prime-countdown", "routes/challenges.goldman-sachs.prime-countdown.tsx"),
