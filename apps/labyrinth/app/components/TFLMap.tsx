  ...
  return (
    ...
    >
      <div className="flex items-start justify-between gap-3">
        <div>
          <h3 className="font-serif text-base font-medium text-stone-900">{camera.commonName}</h3>
...
export default function TFLMap() {
    ...
    return (
      <div className="flex h-full min-h-[24rem] items-center justify-center">
        <div className="max-w-md rounded-2xl border border-stone-200 bg-stone-50 p-8 text-center shadow-sm">
          <h2 className="mb-4 font-serif text-2xl font-medium text-stone-900">
  ...
  return (
    <div className="grid h-full min-h-[24rem] gap-6 lg:grid-cols-[1.35fr_0.85fr]">
      <div className="overflow-hidden rounded-2xl border border-stone-200/70 bg-white shadow-sm">
        <div className="relative h-80 bg-stone-100 md:h-[28rem]">
          <img
          ...
          <div className="absolute bottom-0 left-0 right-0 p-6 text-white">
            <div className="mb-2 flex items-center justify-between gap-4">
              <h2 className="font-serif text-2xl font-medium">{featuredCamera.commonName}</h2>
      ...
      <div className="flex min-h-0 flex-col rounded-2xl border border-stone-200/70 bg-white/80 shadow-sm backdrop-blur-sm">
        <div className="flex items-center justify-between border-b border-stone-200/70 px-5 py-4">
          <div>
            <h2 className="font-serif text-xl font-medium text-stone-900">Camera Index</h2>
