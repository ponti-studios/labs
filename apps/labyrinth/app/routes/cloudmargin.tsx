...
export default function CloudMargin() {
  ...
  return (
    <div>
      ...
      <p>An accrual calculator for financial contracts. Originally a Node/Express app with Jasmine tests.</p>
        ...
        <div className="card">
          ...
          <div style={{ marginBottom: '1rem', padding: '1rem', background: '#f5f5f5', borderRadius: '4px' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '0.5rem', alignItems: 'end' }}>
              ...
              <div>
                <label style={{ display: 'block', marginBottom: '0.25rem', fontSize: '0.875rem' }}>Rate</label>
                <input
                  type="number"
                  step="0.01"
                  placeholder="0.5"
              ...
              <div>
                <label style={{ display: 'block', marginBottom: '0.25rem', fontSize: '0.875rem' }}>Balance</label>
                <input
                  type="number"
                  placeholder="10000"
          ...
          <table style={{ width: '100%', borderCollapse: 'collapse' }}>
            <thead>
              <tr style={{ background: '#f5f5f5' }}>
                ...
                <th style={{ padding: '0.75rem', textAlign: 'right', borderBottom: '2px solid #ddd' }}>Balance</th>
                <th style={{ padding: '0.75rem', textAlign: 'right', borderBottom: '2px solid #ddd' }}>Accrual</th>
              </tr>
            </thead>
            <tbody>
              {accruals.map((accrual, idx) => (
                <tr key={idx} style={{ borderBottom: '1px solid #eee' }}>
                  ...
                  <td style={{ padding: '0.75rem', textAlign: 'right' }}>{accrual.BALANCE.toLocaleString()}</td>
            ...
            <tfoot>
              <tr style={{ fontWeight: 'bold', background: '#f5f5f5' }}>
                <td style={{ padding: '0.75rem' }} colSpan={3}>Total Accruals</td>
                <td style={{ padding: '0.75rem', textAlign: 'right' }}>{totalAccruals.toLocaleString()}</td>
              </tr>
            </tfoot>
          </table>
        </div>
          ...
          <table style={{ width: '100%', borderCollapse: 'collapse' }}>
            <thead>
              <tr style={{ background: '#f5f5f5' }}>
                ...
                <th style={{ padding: '0.75rem', textAlign: 'right', borderBottom: '2px solid #ddd' }}>Amendment</th>
            ...
            <tbody>
              {statements.map((stmt, idx) => (
                <tr key={idx} style={{ borderBottom: '1px solid #eee' }}>
                  ...
                  <td style={{ padding: '0.75rem', textAlign: 'right', color: stmt.AMENDMENT < 0 ? 'red' : 'inherit' }}>
                    {stmt.AMENDMENT.toLocaleString()}
                  </td>
                  <td style={{ padding: '0.75rem', textAlign: 'right' }}>{stmt.TOTAL.toLocaleString()}</td>
                </tr>
              ))}
            </tbody>
          </table>
