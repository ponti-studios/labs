...
export default function GrowthStreet(): JSX.Element {
  return (
    <div>
      ...
      <p>
        A simple banking system with User, Account, Admin, and Payment classes demonstrating async
        transfer operations.
      </p>
      ...
      <div className="card">
        ...
        <ul style={{ textAlign: "left" }}>
          ...
          <li>
            <strong>Account</strong> - Holds balance, async deposit/withdrawal
          </li>
          <li>
            <strong>Admin</strong> - Can transfer between accounts
          </li>
          <li>
            <strong>Payment</strong> - Records transfers between accounts
          </li>
        </ul>
      </div>
