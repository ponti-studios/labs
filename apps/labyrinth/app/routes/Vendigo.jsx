...
const mockBooks = [
  { uid: 'OLID:1', title: 'The Great Gatsby', authors: [{ name: 'F. Scott Fitzgerald' }], cover: null },
  ...
  { uid: 'OLID:5', title: 'The Catcher in the Rye', authors: [{ name: 'J.D. Salinger' }], cover: null },
]
