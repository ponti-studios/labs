...
const routeEntries: RouteEntry[] = [
  ...
  { path: "/challenges/goldman-sachs/fee-or-upfront", href: "/challenges/goldman-sachs/fee-or-upfront", kind: "page" },
  { path: "/challenges/goldman-sachs/prime-countdown", href: "/challenges/goldman-sachs/prime-countdown", kind: "page" },
