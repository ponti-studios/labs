        ...
        <PageSection title="How This Works">
          <div className="space-y-4">
            <p className="text-sm text-white/80">
              This calculator helps you estimate the marketing budget needed to reach a specific
              number of event attendees based on your conversion rate and cost per click.
            </p>
