...
vi.mock("../src/lib/what/server/puzzles.server", () => ({
...
const READY_DAYS = 7; // mirrors WHAT_READY_INVENTORY_DAYS

describe("computeHealthStatus", () => {
  it("returns OK when everything is healthy", async () => {
    const { computeHealthStatus } = await import("./what-health-check");
