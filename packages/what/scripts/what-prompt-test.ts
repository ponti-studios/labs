...
import {
  ...
  generateCandidates,
} from "../src/lib/what/generation/generate.server";
import { PROMPT_TEST_FIXTURES } from "../src/lib/what/fixtures/prompt-test-fixtures";
import { readSourceFixture, type SourceFixture } from "../src/lib/what/fixtures/source-fixtures";
...
async function main() {
  ...
  const promptFiles =
    options.promptFiles.length > 0
      ? options.promptFiles
      : ["src/prompts/what-generation.md", "src/prompts/what-generation-v2.md"];
