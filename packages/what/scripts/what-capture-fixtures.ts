...
import { fetchFeedItems } from "../src/lib/what/generation/ingest.server";
...
function parseOptions() {
  ...
  return {
    outDir: path.resolve(values["out-dir"] ?? "app/lib/what/fixtures/sources"),
