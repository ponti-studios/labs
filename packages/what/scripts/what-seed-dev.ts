/** Seed deterministic What puzzles for local development without an LLM call. */
...
import { ensureSeedPuzzle, requireSeedGame } from "../src/lib/what/server/dev-seed.server";
import { runScript } from "./_shared/run-script";

const SEED_TOPIC_FEED_URL = "https://seed.local/what-dev-feed";
...
async function main() {
  ...
  console.log("\nDone. View: http://localhost:3001/games/what");
}
