...
import { CIRCUIT_BREAKER_THRESHOLD, createCircuitBreaker } from "../src/lib/what/circuit-breaker";
import { getDateKey } from "../src/lib/what/core/date";
import { resolveGenerateRange } from "../src/lib/what/generate-range";
import { WHAT_READY_INVENTORY_DAYS, runGenerateRange } from "../src/lib/what/generation-runner";
import { getActiveGames } from "../src/lib/what/server/games.server";
import {
  backfillPuzzlePublishedAt,
  countInventoryForRange,
} from "../src/lib/what/server/puzzles.server";
...
async function main() {
  ...
  const { expireGenerations, reapStaleGenerations } =
    await import("../src/lib/what/admin/generate.server");
