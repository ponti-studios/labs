      ...
      <TableBody>
        {cells.map((cell) => (
          <TableRow key={cell.dateKey}>
            <TableCell>
              <Link
                to={`/games/game/admin/dates/${cell.dateKey}?game=${gameSlug}`}
        ...
        {generations.map((generation) => (
          <TableRow key={generation.id}>
            <TableCell className="whitespace-nowrap">
              <Link
                to={`/games/game/admin/generations/${generation.id}?game=${gameSlug}`}
            ...
            <TableCell>
              <Link
                to={`/games/game/admin/dates/${generation.dateKey}?game=${gameSlug}`}
                className="text-primary underline-offset-4 hover:underline"
              >
                {generation.dateKey}
              </Link>
