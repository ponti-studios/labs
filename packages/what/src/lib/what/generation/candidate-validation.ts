...
export const WHAT_READY_INVENTORY_DAYS = 7;
...
export function validateCandidate(
  ...
  if (normalizedAnswer.length !== WHAT_ANSWER_LENGTH) {
  ...
  if (normalizedAnswer.length === WHAT_ANSWER_LENGTH && !isDictionaryWord(normalizedAnswer)) {
