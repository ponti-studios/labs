...
--> statement-breakpoint
CREATE TABLE "labs"."relationship_checkins" (
	"id" text PRIMARY KEY NOT NULL,
...
--> statement-breakpoint
CREATE TABLE "labs"."relationship_events" (
	"id" text PRIMARY KEY NOT NULL,
	"person_id" text NOT NULL,
	"owner_user_id" text NOT NULL,
...
--> statement-breakpoint
CREATE TABLE "labs"."relationship_flags" (
	"id" text PRIMARY KEY NOT NULL,
	"person_id" text NOT NULL,
	"owner_user_id" text NOT NULL,
...
--> statement-breakpoint
CREATE TABLE "labs"."relationship_friend_invites" (
	"id" text PRIMARY KEY NOT NULL,
	"person_id" text NOT NULL,
	"owner_user_id" text NOT NULL,
...
--> statement-breakpoint
CREATE TABLE "labs"."relationship_friend_votes" (
	"id" text PRIMARY KEY NOT NULL,
...
--> statement-breakpoint
CREATE TABLE "labs"."relationship_metrics_daily" (
	"id" text PRIMARY KEY NOT NULL,
	"person_id" text NOT NULL,
...
--> statement-breakpoint
CREATE TABLE "labs"."relationship_notes" (
	"id" text PRIMARY KEY NOT NULL,
	"person_id" text NOT NULL,
	"owner_user_id" text NOT NULL,
	"title" text,
...
--> statement-breakpoint
CREATE TABLE "labs"."relationship_people" (
	"id" text PRIMARY KEY NOT NULL,
	"owner_user_id" text NOT NULL,
...
--> statement-breakpoint
CREATE TABLE "labs"."relationship_stage_history" (
	"id" text PRIMARY KEY NOT NULL,
	"person_id" text NOT NULL,
	"from_stage" text,
...
--> statement-breakpoint
ALTER TABLE "labs"."messages" ADD CONSTRAINT "messages_user_id_users_id_fk" FOREIGN KEY ("user_id") REFERENCES "labs"."users"("id") ON DELETE no action ON UPDATE no action;