        ...
        actions={
          <div className="flex flex-wrap gap-2">
            <Button asChild variant="outline">
              <Link to="/games/game/admin/topics">Articles</Link>
            </Button>
            <Button asChild variant="outline">
              <Link to="/games/game/admin/costs">Costs</Link>
            </Button>
            <Button asChild>
              <Link to={`/games/game/admin/generate?game=${overview.game.slug}`}>Generate</Link>
            </Button>
          </div>
        }
      />
      ...
      <section className="flex flex-col gap-3">
        <div className="flex items-start justify-between gap-3">
          ...
          <Button asChild variant="outline" size="sm">
            <Link to={`/games/game/admin/inventory?game=${overview.game.slug}`}>View all</Link>
          </Button>
        </div>
