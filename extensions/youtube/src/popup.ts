...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const calculateChunksButton = document.getElementById("calculate-chunks") as HTMLButtonElement;
  const resultDiv = document.getElementById("result") as HTMLDivElement;
  const timeResult = document.getElementById("time-result") as HTMLDivElement;
  const chunkCalculator = document.getElementById("chunk-calculator") as HTMLDivElement;
  const chunksResult = document.getElementById("chunks-result") as HTMLDivElement;
  ...
  calculateChunksButton.addEventListener("click", () => {
    ...
    const chunkInput = document.getElementById("chunk-minutes") as HTMLInputElement;
