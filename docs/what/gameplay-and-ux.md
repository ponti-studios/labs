...
# What Gameplay and UX

Word games are judged on feel. What had to stay readable under fast input, hold together on mobile, and make each guess feel earned.
...
The share flow copies a spoiler-free emoji grid rather than exposing the answer. That keeps the social ritual intact while fitting the What setting.
